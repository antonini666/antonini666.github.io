...
(function controlColorTheme() {
  ...
  function colorTheme() {
    ...
    $$(".h4").forEach((it) => it.classList.toggle("h4-white"));
  }
})();
...
(function controlLanguage() {
  ...
  function ruTranslator() {
    ...
    $(".portfolio-calculator h2").innerText = "Calculator";
    $(".portfolio-calculator h3").innerText =
      "Приложение Калькулятор. Стек технологий: React Native, Expo, Redux, Styled Components";
    ...
    $(".portfolio-songhero h2").innerText = "Song Dota2 Hero";
    $(".portfolio-songhero h3").innerText =
      "Приложение Song Dota2 Hero - викторина распознавания героев dota2 по их голосам. Стек технологий: React(React Hooks), Redux, Sass";
  ...
  function enTranslator() {
    ...
    $(".portfolio-calculator h2").innerText = "Calculator";
    $(".portfolio-calculator h3").innerText =
      "Calculator app. Technology Stack: React Native, Expo, Redux, Styled Components";
    ...
    $(".portfolio-songhero h2").innerText = "Song Dota2 Hero";
    $(".portfolio-songhero h3").innerText =
      "Song Dota2 Hero app is a quiz for recognizing dota2 hero by their voices. Technology Stack: React(React Hooks), Redux, Sass";
